...
_C.MODEL.CROSS_DISTAN_LOSS_TYPE = 'cosine'
...
# HOGMask
_C.INPUT.HOGMask_PROB = 0.2
_C.INPUT.HOGMask_THRESHOLD = 20
...
_C.DATASETS.TRAIN = ('veri')
_C.DATASETS.TEST = ('veri')
# Root directory where datasets should be used (and downloaded if not found)
_C.DATASETS.ROOT_DIR = ('../data/VeRi')
